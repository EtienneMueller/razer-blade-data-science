...
_For 21.04 I used the nvidia-driver-460 with CUDA 11.2 and TensorFlow 2.6 beta.
Under 21.10 I tested nvidia-driver-470 with CUDA 11.4 and TensorFlow 2.6.
In 22.04 I used nvidia-driver-510 with CUDA 11.6 and TensorFlow 2.8 and 2.9.
Installation procedures were the same for all versions._
